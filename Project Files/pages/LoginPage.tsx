            ...
            <div className="mt-4 space-y-2">
              {demoCredentials.map((demo, index) => (
                <button
                  ...
                  className="w-full text-left px-3 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-md transition-colors duration-200 border border-gray-200"
                >
                  <span className="font-medium">{demo.type}:</span> {demo.email}
                </button>
              ))}
            </div>
          </div>
